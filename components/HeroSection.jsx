    ...
    <main className="py-16 mt-16 md-flex md:shrink-0 ">
      <div className="grid grid-cols-1 md:grid-cols-12 ">
        ...
        >
          <h1 className="font-extrabold">
            ...
            <span className="text-7xl">
              ...
              <TypeWriter
                ...
                onInit={(typewriter) => {
                  typewriter.typeString`<span style="color:#FF77FF">CyberSecurity Student</span>`
                    .pauseFor(1500)
                    .deleteAll()
                    .typeString`<span style="color:#9E7BFF">FullStack Developer</span>`
                    .pauseFor(1500)
                    .deleteAll()
                    .typeString`<span style="color:#893BFF">Future Pen-Tester</span>`
                    .pauseFor(1500)
                    .deleteAll()
                    .start();
                }}
          ...
          <Link
            href="https://drive.google.com/file/d/1CZIqreKjMGXszR7ppdk0mDrXsAIStUDQ/view?usp=sharing"
